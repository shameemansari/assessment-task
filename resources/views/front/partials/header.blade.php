             ...
             <div class="topbar">
                     ...
                     <div class="dropdown">
                         ...
                         <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                             <div class="btn btn-icon btn-hover-transparent-white btn-dropdown btn-lg mr-1">
                                 <span
                                     class="svg-icon svg-icon-xl"><!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg--><svg
                                         xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                         width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                         <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                 ...
                                 <div class="col-6">
                                     <a href="#"
                                         ...
                                         <span
                                             ...
                                             class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Jobs
                                             List</span>
                                     </a>
                                 </div>
                                 <!--end:Item-->
                                 ...
                                 <div class="col-6">
                                     <a href="#"
                                         ...
                                         <span
                                             ...
                                             class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Candidates</span>
                                     </a>
                                 </div>
                                 <!--end:Item-->
                                 ...
                                 <div class="col-6">
                                     <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right">
                                         <span
                                             ...
                                             class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Employers</span>
                                     </a>
                                 </div>
                                 <!--end:Item-->
                                 ...
                                 <div class="col-6">
                                     <a href="#" class="d-block py-10 px-5 text-center bg-hover-light">
                                         <span
                                             ...
                                             class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Users</span>
                                     </a>
                                 </div>
                                 <!--end:Item-->
                             </div>
                     ...
                     <div class="topbar-item">
                         <div class="btn btn-icon btn-hover-transparent-white w-auto d-flex align-items-center btn-lg px-2"
                             ...
                             <div class="d-flex flex-column text-right pr-3">
                                 ...
                                 <span
                                     class="text-white font-weight-bolder font-size-sm d-none d-md-inline">{{ auth()->user()?->roles?->first()->name }}</span>
                             </div>
                 ...
                 @guest
                     <div class="topbar-item">
                         <a href="{{ route('login') }}">
                             <div
                                 class="mx-1 btn btn-icon bg-white-o-40 w-auto d-flex align-items-center px-2">
                                 <span class="py-2 px-5 font-weight-bold text-white">
                                     Login
                                 </span>
                             </div>
